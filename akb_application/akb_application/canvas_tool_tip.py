...
class CanvasTooltip: # https://stackoverflow.com/questions/40538204/how-i-can-make-a-tooltip-appear-over-a-canvas-area-bounded-by-a-box
    '''
    ...
    def __init__(self, canvas: tk.Canvas, tag_or_id,
                 *,
                 bg='#EBEBEB',
                 pad=(5, 3, 5, 3),
                 text='canvas info',
