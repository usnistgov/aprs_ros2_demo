...
from akb_application.robot_status_frame import StatusFrame
...
class App(ctk.CTk):
    def __init__(self, node: Node):
        ...
        StatusFrame(self, self.node, row=1, col=3)
        ...
        # self.robot_status_frame.grid(row=0, column=0, sticky="NSWE")
