...
#include "aprs_interfaces/msg/detail/objects__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const aprs_interfaces::msg::Object &,
...
cdr_serialize(
  const aprs_interfaces::msg::Objects & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  aprs_interfaces::msg::Objects & ros_message)
{
  // Member: objects
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  // Member: objects
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        aprs_interfaces::msg::typesupport_fastrtps_cpp::max_serialized_size_Object(
  ...
  if (is_plain) {
    ...
    using DataType = aprs_interfaces::msg::Objects;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const aprs_interfaces::msg::Objects *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<aprs_interfaces::msg::Objects *>(
    untyped_ros_message);
...
{
  return &aprs_interfaces::msg::typesupport_fastrtps_cpp::_Objects__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, aprs_interfaces, msg, Objects)() {
  return &aprs_interfaces::msg::typesupport_fastrtps_cpp::_Objects__handle;
}
