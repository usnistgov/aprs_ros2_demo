...
#include "aprs_interfaces/srv/detail/move_to_named_pose__rosidl_typesupport_fastrtps_c.h"
...
using _MoveToNamedPose_Request__ros_msg_type = aprs_interfaces__srv__MoveToNamedPose_Request;
  ...
  void * untyped_ros_message)
{
  ...
  _MoveToNamedPose_Request__ros_msg_type * ros_message = static_cast<_MoveToNamedPose_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: name
  {
    std::string tmp;
    cdr >> tmp;
...
size_t get_serialized_size_aprs_interfaces__srv__MoveToNamedPose_Request(
  const void * untyped_ros_message,
...
static uint32_t _MoveToNamedPose_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_aprs_interfaces__srv__MoveToNamedPose_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_aprs_interfaces
size_t max_serialized_size_aprs_interfaces__srv__MoveToNamedPose_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = aprs_interfaces__srv__MoveToNamedPose_Request;
    is_plain =
      (
...
static size_t _MoveToNamedPose_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_aprs_interfaces__srv__MoveToNamedPose_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aprs_interfaces, srv, MoveToNamedPose_Request)() {
...
using _MoveToNamedPose_Response__ros_msg_type = aprs_interfaces__srv__MoveToNamedPose_Response;
  ...
  void * untyped_ros_message)
{
  ...
  _MoveToNamedPose_Response__ros_msg_type * ros_message = static_cast<_MoveToNamedPose_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: success
  {
    uint8_t tmp;
    cdr >> tmp;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_aprs_interfaces
size_t get_serialized_size_aprs_interfaces__srv__MoveToNamedPose_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MoveToNamedPose_Response__ros_msg_type * ros_message = static_cast<const _MoveToNamedPose_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_aprs_interfaces__srv__MoveToNamedPose_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_aprs_interfaces
size_t max_serialized_size_aprs_interfaces__srv__MoveToNamedPose_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = aprs_interfaces__srv__MoveToNamedPose_Response;
    is_plain =
      (
...
static size_t _MoveToNamedPose_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_aprs_interfaces__srv__MoveToNamedPose_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aprs_interfaces, srv, MoveToNamedPose_Response)() {
...
using _MoveToNamedPose_Event__ros_msg_type = aprs_interfaces__srv__MoveToNamedPose_Event;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: request
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, aprs_interfaces, srv, MoveToNamedPose_Request
      )()->data);
  ...
  // Field name: response
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, aprs_interfaces, srv, MoveToNamedPose_Response
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  _MoveToNamedPose_Event__ros_msg_type * ros_message = static_cast<_MoveToNamedPose_Event__ros_msg_type *>(untyped_ros_message);
  // Field name: info
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: request
  {
    ...
    if (ros_message->request.data) {
      aprs_interfaces__srv__MoveToNamedPose_Request__Sequence__fini(&ros_message->request);
    }
    if (!aprs_interfaces__srv__MoveToNamedPose_Request__Sequence__init(&ros_message->request, size)) {
  ...
  // Field name: response
  {
    ...
    if (ros_message->response.data) {
      aprs_interfaces__srv__MoveToNamedPose_Response__Sequence__fini(&ros_message->response);
    }
    if (!aprs_interfaces__srv__MoveToNamedPose_Response__Sequence__init(&ros_message->response, size)) {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_aprs_interfaces
size_t get_serialized_size_aprs_interfaces__srv__MoveToNamedPose_Event(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MoveToNamedPose_Event__ros_msg_type * ros_message = static_cast<const _MoveToNamedPose_Event__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_aprs_interfaces__srv__MoveToNamedPose_Request(
  ...
  // field.name response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_aprs_interfaces__srv__MoveToNamedPose_Response(
        &array_ptr[index], current_alignment);
    }
  }
...
{
  return static_cast<uint32_t>(
    get_serialized_size_aprs_interfaces__srv__MoveToNamedPose_Event(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_aprs_interfaces
size_t max_serialized_size_aprs_interfaces__srv__MoveToNamedPose_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_aprs_interfaces__srv__MoveToNamedPose_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_aprs_interfaces__srv__MoveToNamedPose_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = aprs_interfaces__srv__MoveToNamedPose_Event;
    is_plain =
      (
...
static size_t _MoveToNamedPose_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_aprs_interfaces__srv__MoveToNamedPose_Event(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aprs_interfaces, srv, MoveToNamedPose_Event)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aprs_interfaces, srv, MoveToNamedPose)() {
