...
#include "aprs_interfaces/srv/detail/pick__rosidl_typesupport_fastrtps_c.h"
...
using _Pick_Request__ros_msg_type = aprs_interfaces__srv__Pick_Request;
...
size_t get_serialized_size_aprs_interfaces__srv__Pick_Request(
  const void * untyped_ros_message,
...
static uint32_t _Pick_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_aprs_interfaces__srv__Pick_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_aprs_interfaces
size_t max_serialized_size_aprs_interfaces__srv__Pick_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = aprs_interfaces__srv__Pick_Request;
    is_plain =
      (
...
static size_t _Pick_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_aprs_interfaces__srv__Pick_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aprs_interfaces, srv, Pick_Request)() {
...
using _Pick_Response__ros_msg_type = aprs_interfaces__srv__Pick_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_aprs_interfaces
size_t get_serialized_size_aprs_interfaces__srv__Pick_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Pick_Response__ros_msg_type * ros_message = static_cast<const _Pick_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_aprs_interfaces__srv__Pick_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_aprs_interfaces
size_t max_serialized_size_aprs_interfaces__srv__Pick_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = aprs_interfaces__srv__Pick_Response;
    is_plain =
      (
...
static size_t _Pick_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_aprs_interfaces__srv__Pick_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aprs_interfaces, srv, Pick_Response)() {
...
using _Pick_Event__ros_msg_type = aprs_interfaces__srv__Pick_Event;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Pick_Event__ros_msg_type * ros_message = static_cast<const _Pick_Event__ros_msg_type *>(untyped_ros_message);
  // Field name: info
  {
  ...
  // Field name: request
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, aprs_interfaces, srv, Pick_Request
      )()->data);
  ...
  // Field name: response
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, aprs_interfaces, srv, Pick_Response
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  _Pick_Event__ros_msg_type * ros_message = static_cast<_Pick_Event__ros_msg_type *>(untyped_ros_message);
  // Field name: info
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: request
  {
    ...
    if (ros_message->request.data) {
      aprs_interfaces__srv__Pick_Request__Sequence__fini(&ros_message->request);
    }
    if (!aprs_interfaces__srv__Pick_Request__Sequence__init(&ros_message->request, size)) {
  ...
  // Field name: response
  {
    ...
    if (ros_message->response.data) {
      aprs_interfaces__srv__Pick_Response__Sequence__fini(&ros_message->response);
    }
    if (!aprs_interfaces__srv__Pick_Response__Sequence__init(&ros_message->response, size)) {
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_aprs_interfaces
size_t get_serialized_size_aprs_interfaces__srv__Pick_Event(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Pick_Event__ros_msg_type * ros_message = static_cast<const _Pick_Event__ros_msg_type *>(untyped_ros_message);
  ...
  // field.name request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_aprs_interfaces__srv__Pick_Request(
  ...
  // field.name response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_aprs_interfaces__srv__Pick_Response(
        &array_ptr[index], current_alignment);
    }
  }
...
static uint32_t _Pick_Event__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_aprs_interfaces__srv__Pick_Event(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_aprs_interfaces
size_t max_serialized_size_aprs_interfaces__srv__Pick_Event(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  // member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_aprs_interfaces__srv__Pick_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_aprs_interfaces__srv__Pick_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = aprs_interfaces__srv__Pick_Event;
    is_plain =
      (
...
static size_t _Pick_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_aprs_interfaces__srv__Pick_Event(
    full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t __callbacks_Pick_Event = {
  "aprs_interfaces::srv",
  "Pick_Event",
...
static rosidl_message_type_support_t _Pick_Event__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_Pick_Event,
  get_message_typesupport_handle_function,
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aprs_interfaces, srv, Pick_Event)() {
  return &_Pick_Event__type_support;
}
...
static rosidl_service_type_support_t Pick__handle = {
  ...
  &_Pick_Request__type_support,
  &_Pick_Response__type_support,
  &_Pick_Event__type_support,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aprs_interfaces, srv, Pick)() {
  return &Pick__handle;
}
