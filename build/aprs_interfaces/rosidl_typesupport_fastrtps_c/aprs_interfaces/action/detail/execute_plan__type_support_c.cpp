...
#include "aprs_interfaces/action/detail/execute_plan__rosidl_typesupport_fastrtps_c.h"
...
using _ExecutePlan_Goal__ros_msg_type = aprs_interfaces__action__ExecutePlan_Goal;
...
static uint32_t _ExecutePlan_Goal__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_aprs_interfaces__action__ExecutePlan_Goal(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = aprs_interfaces__action__ExecutePlan_Goal;
    is_plain =
      (
...
static size_t _ExecutePlan_Goal__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_aprs_interfaces__action__ExecutePlan_Goal(
...
using _ExecutePlan_Result__ros_msg_type = aprs_interfaces__action__ExecutePlan_Result;
...
{
  return static_cast<uint32_t>(
    get_serialized_size_aprs_interfaces__action__ExecutePlan_Result(
      untyped_ros_message, 0));
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = aprs_interfaces__action__ExecutePlan_Result;
    is_plain =
      (
      offsetof(DataType, structure_needs_at_least_one_member) +
      last_member_size
...
static size_t _ExecutePlan_Result__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_aprs_interfaces__action__ExecutePlan_Result(
    full_bounded, is_plain, 0);
...
using _ExecutePlan_Feedback__ros_msg_type = aprs_interfaces__action__ExecutePlan_Feedback;
...
{
  return static_cast<uint32_t>(
    get_serialized_size_aprs_interfaces__action__ExecutePlan_Feedback(
      untyped_ros_message, 0));
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = aprs_interfaces__action__ExecutePlan_Feedback;
    is_plain =
      (
      offsetof(DataType, structure_needs_at_least_one_member) +
      last_member_size
...
static size_t _ExecutePlan_Feedback__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_aprs_interfaces__action__ExecutePlan_Feedback(
    full_bounded, is_plain, 0);
...
// already included above
// #include "aprs_interfaces/action/detail/execute_plan__functions.h"  // goal
...
using _ExecutePlan_SendGoal_Request__ros_msg_type = aprs_interfaces__action__ExecutePlan_SendGoal_Request;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: goal
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, aprs_interfaces, action, ExecutePlan_Goal
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_aprs_interfaces__action__ExecutePlan_Goal(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_aprs_interfaces__action__ExecutePlan_SendGoal_Request(
      untyped_ros_message, 0));
}
  ...
  size_t current_alignment)
{
  ...
  // member: goal
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_aprs_interfaces__action__ExecutePlan_Goal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = aprs_interfaces__action__ExecutePlan_SendGoal_Request;
    is_plain =
      (
...
static size_t _ExecutePlan_SendGoal_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_aprs_interfaces__action__ExecutePlan_SendGoal_Request(
    full_bounded, is_plain, 0);
...
using _ExecutePlan_SendGoal_Response__ros_msg_type = aprs_interfaces__action__ExecutePlan_SendGoal_Response;
...
{
  return static_cast<uint32_t>(
    get_serialized_size_aprs_interfaces__action__ExecutePlan_SendGoal_Response(
      untyped_ros_message, 0));
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = aprs_interfaces__action__ExecutePlan_SendGoal_Response;
    is_plain =
      (
...
static size_t _ExecutePlan_SendGoal_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_aprs_interfaces__action__ExecutePlan_SendGoal_Response(
    full_bounded, is_plain, 0);
...
using _ExecutePlan_SendGoal_Event__ros_msg_type = aprs_interfaces__action__ExecutePlan_SendGoal_Event;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ExecutePlan_SendGoal_Event__ros_msg_type * ros_message = static_cast<const _ExecutePlan_SendGoal_Event__ros_msg_type *>(untyped_ros_message);
  // Field name: info
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: request
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, aprs_interfaces, action, ExecutePlan_SendGoal_Request
      )()->data);
  ...
  // Field name: response
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, aprs_interfaces, action, ExecutePlan_SendGoal_Response
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  _ExecutePlan_SendGoal_Event__ros_msg_type * ros_message = static_cast<_ExecutePlan_SendGoal_Event__ros_msg_type *>(untyped_ros_message);
  // Field name: info
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: request
  {
    ...
    if (ros_message->request.data) {
      aprs_interfaces__action__ExecutePlan_SendGoal_Request__Sequence__fini(&ros_message->request);
    }
    if (!aprs_interfaces__action__ExecutePlan_SendGoal_Request__Sequence__init(&ros_message->request, size)) {
  ...
  // Field name: response
  {
    ...
    if (ros_message->response.data) {
      aprs_interfaces__action__ExecutePlan_SendGoal_Response__Sequence__fini(&ros_message->response);
    }
    if (!aprs_interfaces__action__ExecutePlan_SendGoal_Response__Sequence__init(&ros_message->response, size)) {
  ...
  size_t current_alignment)
{
  ...
  // field.name request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_aprs_interfaces__action__ExecutePlan_SendGoal_Request(
  ...
  // field.name response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_aprs_interfaces__action__ExecutePlan_SendGoal_Response(
        &array_ptr[index], current_alignment);
    }
  }
...
static uint32_t _ExecutePlan_SendGoal_Event__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_aprs_interfaces__action__ExecutePlan_SendGoal_Event(
      untyped_ros_message, 0));
}
  ...
  size_t current_alignment)
{
  ...
  // member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_aprs_interfaces__action__ExecutePlan_SendGoal_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_aprs_interfaces__action__ExecutePlan_SendGoal_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = aprs_interfaces__action__ExecutePlan_SendGoal_Event;
    is_plain =
      (
...
static size_t _ExecutePlan_SendGoal_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_aprs_interfaces__action__ExecutePlan_SendGoal_Event(
    full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t __callbacks_ExecutePlan_SendGoal_Event = {
  "aprs_interfaces::action",
...
static rosidl_message_type_support_t _ExecutePlan_SendGoal_Event__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ExecutePlan_SendGoal_Event,
  get_message_typesupport_handle_function,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aprs_interfaces, action, ExecutePlan_SendGoal_Event)() {
  return &_ExecutePlan_SendGoal_Event__type_support;
}
...
static rosidl_service_type_support_t ExecutePlan_SendGoal__handle = {
  ...
  &_ExecutePlan_SendGoal_Request__type_support,
  &_ExecutePlan_SendGoal_Response__type_support,
  &_ExecutePlan_SendGoal_Event__type_support,
...
using _ExecutePlan_GetResult_Request__ros_msg_type = aprs_interfaces__action__ExecutePlan_GetResult_Request;
...
{
  return static_cast<uint32_t>(
    get_serialized_size_aprs_interfaces__action__ExecutePlan_GetResult_Request(
      untyped_ros_message, 0));
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = aprs_interfaces__action__ExecutePlan_GetResult_Request;
    is_plain =
      (
...
static size_t _ExecutePlan_GetResult_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_aprs_interfaces__action__ExecutePlan_GetResult_Request(
    full_bounded, is_plain, 0);
...
// already included above
// #include "aprs_interfaces/action/detail/execute_plan__functions.h"  // result
...
using _ExecutePlan_GetResult_Response__ros_msg_type = aprs_interfaces__action__ExecutePlan_GetResult_Response;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: result
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, aprs_interfaces, action, ExecutePlan_Result
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_aprs_interfaces__action__ExecutePlan_Result(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_aprs_interfaces__action__ExecutePlan_GetResult_Response(
      untyped_ros_message, 0));
}
  ...
  size_t current_alignment)
{
  ...
  // member: result
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_aprs_interfaces__action__ExecutePlan_Result(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = aprs_interfaces__action__ExecutePlan_GetResult_Response;
    is_plain =
      (
...
static size_t _ExecutePlan_GetResult_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_aprs_interfaces__action__ExecutePlan_GetResult_Response(
    full_bounded, is_plain, 0);
...
using _ExecutePlan_GetResult_Event__ros_msg_type = aprs_interfaces__action__ExecutePlan_GetResult_Event;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ExecutePlan_GetResult_Event__ros_msg_type * ros_message = static_cast<const _ExecutePlan_GetResult_Event__ros_msg_type *>(untyped_ros_message);
  // Field name: info
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: request
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, aprs_interfaces, action, ExecutePlan_GetResult_Request
      )()->data);
    size_t size = ros_message->request.size;
    auto array_ptr = ros_message->request.data;
    if (size > 1) {
  ...
  // Field name: response
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, aprs_interfaces, action, ExecutePlan_GetResult_Response
      )()->data);
    size_t size = ros_message->response.size;
    auto array_ptr = ros_message->response.data;
    if (size > 1) {
  ...
  void * untyped_ros_message)
{
  ...
  _ExecutePlan_GetResult_Event__ros_msg_type * ros_message = static_cast<_ExecutePlan_GetResult_Event__ros_msg_type *>(untyped_ros_message);
  // Field name: info
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
  ...
  // Field name: request
  {
    ...
    size_t size = static_cast<size_t>(cdrSize);
    if (ros_message->request.data) {
      aprs_interfaces__action__ExecutePlan_GetResult_Request__Sequence__fini(&ros_message->request);
    }
    if (!aprs_interfaces__action__ExecutePlan_GetResult_Request__Sequence__init(&ros_message->request, size)) {
      fprintf(stderr, "failed to create array for field 'request'");
      return false;
    }
    auto array_ptr = ros_message->request.data;
  ...
  // Field name: response
  {
    ...
    size_t size = static_cast<size_t>(cdrSize);
    if (ros_message->response.data) {
      aprs_interfaces__action__ExecutePlan_GetResult_Response__Sequence__fini(&ros_message->response);
    }
    if (!aprs_interfaces__action__ExecutePlan_GetResult_Response__Sequence__init(&ros_message->response, size)) {
      fprintf(stderr, "failed to create array for field 'response'");
      return false;
    }
    auto array_ptr = ros_message->response.data;
  ...
  size_t current_alignment)
{
  ...
  // field.name request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_aprs_interfaces__action__ExecutePlan_GetResult_Request(
        &array_ptr[index], current_alignment);
    }
  }
  // field.name response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_aprs_interfaces__action__ExecutePlan_GetResult_Response(
        &array_ptr[index], current_alignment);
    }
  }
...
static uint32_t _ExecutePlan_GetResult_Event__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_aprs_interfaces__action__ExecutePlan_GetResult_Event(
      untyped_ros_message, 0));
}
  ...
  size_t current_alignment)
{
  ...
  // member: request
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_aprs_interfaces__action__ExecutePlan_GetResult_Request(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  // member: response
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_aprs_interfaces__action__ExecutePlan_GetResult_Response(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = aprs_interfaces__action__ExecutePlan_GetResult_Event;
    is_plain =
      (
      offsetof(DataType, response) +
      last_member_size
...
static size_t _ExecutePlan_GetResult_Event__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_aprs_interfaces__action__ExecutePlan_GetResult_Event(
    full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t __callbacks_ExecutePlan_GetResult_Event = {
  "aprs_interfaces::action",
...
static rosidl_message_type_support_t _ExecutePlan_GetResult_Event__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ExecutePlan_GetResult_Event,
  get_message_typesupport_handle_function,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, aprs_interfaces, action, ExecutePlan_GetResult_Event)() {
  return &_ExecutePlan_GetResult_Event__type_support;
}
...
static rosidl_service_type_support_t ExecutePlan_GetResult__handle = {
  ...
  get_service_typesupport_handle_function,
  &_ExecutePlan_GetResult_Request__type_support,
  &_ExecutePlan_GetResult_Response__type_support,
  &_ExecutePlan_GetResult_Event__type_support,
  ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_CREATE_EVENT_MESSAGE_SYMBOL_NAME(
    rosidl_typesupport_c,
    aprs_interfaces,
    action,
...
// already included above
// #include "aprs_interfaces/action/detail/execute_plan__functions.h"  // feedback
// already included above
// #include "unique_identifier_msgs/msg/detail/uuid__functions.h"  // goal_id
...
using _ExecutePlan_FeedbackMessage__ros_msg_type = aprs_interfaces__action__ExecutePlan_FeedbackMessage;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: feedback
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, aprs_interfaces, action, ExecutePlan_Feedback
      )()->data);
    if (!callbacks->cdr_serialize(
  ...
  size_t current_alignment)
{
  ...
  current_alignment += get_serialized_size_aprs_interfaces__action__ExecutePlan_Feedback(
...
{
  return static_cast<uint32_t>(
    get_serialized_size_aprs_interfaces__action__ExecutePlan_FeedbackMessage(
      untyped_ros_message, 0));
}
  ...
  size_t current_alignment)
{
  ...
  // member: feedback
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_aprs_interfaces__action__ExecutePlan_Feedback(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = aprs_interfaces__action__ExecutePlan_FeedbackMessage;
    is_plain =
      (
...
static size_t _ExecutePlan_FeedbackMessage__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_aprs_interfaces__action__ExecutePlan_FeedbackMessage(
    full_bounded, is_plain, 0);
