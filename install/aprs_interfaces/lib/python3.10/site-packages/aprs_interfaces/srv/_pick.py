...
class Metaclass_Pick_Event(type):
    """Metaclass of message 'Pick_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__pick__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__pick__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__pick__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__pick__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__pick__event
...
class Pick_Event(metaclass=Metaclass_Pick_Event):
    """Message class 'Pick_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<aprs_interfaces/Pick_Request, 1>',
        'response': 'sequence<aprs_interfaces/Pick_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['aprs_interfaces', 'srv'], 'Pick_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['aprs_interfaces', 'srv'], 'Pick_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from aprs_interfaces.srv import Pick_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, Pick_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'Pick_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from aprs_interfaces.srv import Pick_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, Pick_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'Pick_Response'"
...
class Metaclass_Pick(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from aprs_interfaces.srv import _pick
            ...
            if _pick.Metaclass_Pick_Event._TYPE_SUPPORT is None:
                _pick.Metaclass_Pick_Event.__import_type_support__()


class Pick(metaclass=Metaclass_Pick):
    from aprs_interfaces.srv._pick import Pick_Request as Request
    from aprs_interfaces.srv._pick import Pick_Response as Response
    from aprs_interfaces.srv._pick import Pick_Event as Event
