  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0xa9, 0x18, 0x2f, 0x6e, 0x14, 0x1b, 0xe7, 0x7f,
      0xc5, 0x67, 0x3b, 0x33, 0x32, 0xc6, 0xd5, 0x95,
      0xbe, 0xcb, 0x1b, 0x5d, 0x98, 0xcd, 0x71, 0x5a,
      0x84, 0x6f, 0xa4, 0x31, 0xa0, 0xbc, 0xb7, 0xe9,
    }};
  return &hash;
}
...
#ifndef NDEBUG
static const rosidl_type_hash_t aprs_interfaces__msg__Object__EXPECTED_HASH = {1, {
...
static char aprs_interfaces__msg__Objects__TYPE_NAME[] = "aprs_interfaces/msg/Objects";
...
static char aprs_interfaces__msg__Objects__FIELD_NAME__objects[] = "objects";

static rosidl_runtime_c__type_description__Field aprs_interfaces__msg__Objects__FIELDS[] = {
  {
    {aprs_interfaces__msg__Objects__FIELD_NAME__objects, 7, 7},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription aprs_interfaces__msg__Objects__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
    {aprs_interfaces__msg__Object__TYPE_NAME, 26, 26},
    {NULL, 0, 0},
  },
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {aprs_interfaces__msg__Objects__TYPE_NAME, 27, 27},
      {aprs_interfaces__msg__Objects__FIELDS, 1, 1},
    },
    {aprs_interfaces__msg__Objects__REFERENCED_TYPE_DESCRIPTIONS, 7, 7},
  };
  if (!constructed) {
    assert(0 == memcmp(&aprs_interfaces__msg__Object__EXPECTED_HASH, aprs_interfaces__msg__Object__get_type_hash(NULL), sizeof(rosidl_type_hash_t)));
    description.referenced_type_descriptions.data[0].fields = aprs_interfaces__msg__Object__get_type_description(NULL)->type_description.fields;
...
static char toplevel_type_raw_source[] =
  "aprs_interfaces/Object[] objects";
...
aprs_interfaces__msg__Objects__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *aprs_interfaces__msg__Objects__get_individual_type_description_source(NULL),
    sources[1] = *aprs_interfaces__msg__Object__get_individual_type_description_source(NULL);
