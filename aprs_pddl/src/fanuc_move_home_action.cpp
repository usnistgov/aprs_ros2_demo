...
: plansys2::ActionExecutorClient("fanuc_move_home", std::chrono::milliseconds(250)),
  waiting_for_response_{false},
  service_called_{false}
{
  move_home_client_ = this->create_client<aprs_interfaces::srv::MoveToNamedPose>("/fanuc/move_to_named_pose");
}
...
int main(int argc, char **argv)
{
  ...
  node->set_parameter(rclcpp::Parameter("action_name", "fanuc_move_home"));
