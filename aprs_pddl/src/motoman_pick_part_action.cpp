...
: plansys2::ActionExecutorClient("motoman_pick_part", std::chrono::milliseconds(250)),
  waiting_for_response_{false},
  service_called_{false}
{
  pick_part_client_ = this->create_client<aprs_interfaces::srv::Pick>("/motoman/pick_from_slot");
}
...
int main(int argc, char **argv)
{
  ...
  node->set_parameter(rclcpp::Parameter("action_name", "motoman_pick"));
