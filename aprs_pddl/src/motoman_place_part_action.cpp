...
: plansys2::ActionExecutorClient("motoman_place_part", std::chrono::milliseconds(250)),
  waiting_for_response_{false},
  service_called_{false}
{
  place_part_client_ = this->create_client<aprs_interfaces::srv::Place>("/motoman/place_in_slot");
}
...
int main(int argc, char **argv)
{
  ...
  node->set_parameter(rclcpp::Parameter("action_name", "motoman_place"));
